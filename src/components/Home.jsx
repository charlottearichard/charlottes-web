...
function Home() {
  return (
    ...
    <div>
        <button className="py-3 font-[Inconsolata] text-2xl text-[#708897] border-4 border-[#708897] px-6 my-2 flex items-center hover:bg-[#708897] hover:text-[#e4ebef]" > LEARN MORE <HiArrowNarrowRight /> </button>
    </div>
